	...
	,	getAvailableCreditcards: function ()
		{
			// Creditcards
			var creditcards = []
			,	user_creditcards = ProfileModel.getInstance().get('creditcards');
	...
	,	getContext: function ()
		{
			...
			,	imageCvvAmericanCardURL: _.getAbsoluteUrl(Configuration.get('creditCard.imageCvvAmericanCard'))
				//@property {String} imageCvvAllCards
			,	imageCvvAllCardsURL: _.getAbsoluteUrl(Configuration.get('creditCard.imageCvvAllCards'))
