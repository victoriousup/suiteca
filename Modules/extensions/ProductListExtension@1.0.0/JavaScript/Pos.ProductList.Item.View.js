	...
	,	getContext: function()
		{
			...
			,	thumbnail = item.get('itemDetails').get('_thumbnail')
			,	itemtype = item.get('itemDetails').get('itemtype');
			...
			,	itemDetailsPriceFormattedCurrency: SC.Utils.formatCurrency(item.get('itemDetails').get('pricelevel1'))
