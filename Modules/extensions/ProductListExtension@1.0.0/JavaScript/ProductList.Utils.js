	...
	)
{
	...
	return function (application)
	{
		...
		,	isSingleList: function ()
			{
				return !application.getConfig('productList.additionEnabled') &&
					application.getConfig('productList.listTemplates') &&
					_.filter(application.getConfig('productList.listTemplates'), function (pl) { return pl.typeName !== 'later'; }).length === 1 ;
			}
		...
		,	renderProductLists: function (view)
			...
			// @param {ItemDetails.Model} product @return {String}
