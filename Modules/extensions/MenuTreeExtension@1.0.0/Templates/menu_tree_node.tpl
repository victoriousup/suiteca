...
<div class="menu-tree-node list-group-item" data-type="menu-tree-node-expandable" data-type="menu-tree-node-expandable" data-id='{{node.id}}' data-permissions="{{node.permission}}" data-permissions-operator="{{node.permissionOperator}}">
...
{{else}}
<div class="menu-tree-node {{#if node.firstItem}}list-group-item{{/if}}" data-type="menu-tree-node" data-permissions="{{node.permission}}" data-permissions-operator="{{node.permissionOperator}}">
