...
<section class="print-statement panel panel-smart">
	<div class="panel-heading">
		<h3 class="print-statement-title panel-title">{{pageHeader}}</h3>
	</div>
	...
	<form class="print-statement-form">
		...
		<div class="print-statement-form-group" data-validation="control-group">
			...
			<div  class="print-statement-form-controls" data-validation="control">
				<input type="date" data-format="yyyy-mm-dd" id="statementDate" name="statementDate" class="print-statement-form-group-input" placeholder="{{translate 'YYYY-MM-DD'}}" autocomplete="off" data-todayhighlight="true"/>
		...
		<div class="print-statement-form-group" data-validation="control-group">
			...
			<div  class="print-statement-form-controls" data-validation="control">
				<input type="date" data-format="yyyy-mm-dd" id="startDate" name="startDate" class="print-statement-form-group-input" placeholder="{{translate 'YYYY-MM-DD'}}" autocomplete="off" data-todayhighlight="true"/>
				<i class="print-statement-form-input-icon"></i>
			</div>
		</div>
