...
<section class="return-authorization-list panel panel-smart">
	<header class="return-authorization-list-header panel-heading">
		<h3 class="panel-title">{{pageHeader}}</h3>
	</header>
