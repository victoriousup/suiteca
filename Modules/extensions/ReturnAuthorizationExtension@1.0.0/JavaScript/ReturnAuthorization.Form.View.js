...
,	[	'ListHeader.View'
	...
	,	'SC.Configuration'
	,	'ItemViews.Cell.SelectableActionableNavigable.View'
...
,	function (
	...
	,	Configuration
	,	ItemViewsCellSelectableActionableNavigableView
	...
	)
{
	...
	//Class ReturnAuthorization.Form.View @extedn Backbone.View
	...
	,	parseLines: function ()
		{
			...
			this.createdFromModel.set('invalidLines', new OrderLineCollection(lines_group.invalidLines));
		...
		,	'Returnable.Lines.Collection': function ()
			{
				...
				,	childView: ItemViewsCellSelectableActionableNavigableView
				,	viewsPerRow: 1
				,	childViewOptions: {
