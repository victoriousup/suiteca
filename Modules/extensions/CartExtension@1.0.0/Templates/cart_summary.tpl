...
<div class="cart-summary panel panel-smart">
		...
		{{#if isPriceEnabled}}
			...
			{{#if showPromocodeForm}}
				<div class="cart-summary-grid">
					...
					<div class="cart-summary-expander-body collapse"  style="margin-left: 15px;margin-right: 15px;" role="form" id="promo-code-container" aria-expanded="false">
			...
			{{#if showActions}}
				<div class="cart-summary-button-container">
					<div class="col-sm-6 text-center" style="padding: 10px;">
						<a id="btn-proceed-checkout" class="cart-summary-button-proceed-checkout {{#if showProceedButton}} cart-summary-button-proceed-checkout-sb {{/if}} btn btn-lg btn-warning" href="#" data-touchpoint="checkout" data-hashtag="#">
							{{translate 'Proceed to Checkout'}}
						</a>
					</div>
					{{#if showPaypalButton}}
						<div class="cart-summary-btn-paypal-express col-sm-6">
