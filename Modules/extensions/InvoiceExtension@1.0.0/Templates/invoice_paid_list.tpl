...
<section class="invoice-paid-list panel panel-smart">
	<header class="invoice-paid-list-header panel-heading">
		<h3 class="invoice-paid-list-title panel-title">{{pageHeader}}</h3>		
	</header>
