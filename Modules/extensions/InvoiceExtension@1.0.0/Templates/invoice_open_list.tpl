...
<section class="invoice-open-list panel panel-smart">

	<header class="invoice-open-list-header panel-heading">
		<h3 class="invoice-open-list-title panel-title">{{pageHeader}}</h3>
	</header>
