...
<section class="overview-home panel panel-smart">
	<div class="overview-home-orders" data-permissions="{{purchasesPermissions}}">
		<div class="overview-home-orders-title panel-heading">
			<h3 class="panel-title">{{translate 'Recent Purchases'}}</h3>
...
<section class="overview-home-mysettings panel panel-smart">
	<div class="panel-heading">
		<h3 class="panel-title">{{translate 'My Settings'}}</h3>
	</div>
