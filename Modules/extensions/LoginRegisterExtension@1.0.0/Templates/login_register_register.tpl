...
<div class="panel-heading">
	<h3 class="login-register-login-title panel-title">{{translate 'Create New Account'}}</h3>
</div>
<div class="panel-body">
	...
	<form class="login-register-register-form form-horizontal" method="POST" novalidate role="form">
	{{/unless}}
		<div class="login-register-register-form-controls-group form-group" data-validation="control-group">
			<label class="login-register-register-form-label col-sm-4 control-label" for="register-firstname">
				{{translate 'First Name <sup class="login-register-register-form-required">*</sup>'}}
			</label>
			<div class="login-register-register-form-controls col-sm-8" data-validation="control">
				<input {{#if hasAutoFocus}} autofocus {{/if}} type="text" name="firstname" id="register-firstname" class="login-register-register-form-input form-control">
			</div>
		</div>
		<div class="login-register-register-form-controls-group form-group" data-validation="control-group">
			<label class="login-register-register-form-label col-sm-4 control-label" for="register-lastname">
				{{translate 'Last Name <sup class="login-register-register-form-required">*</sup>'}}
			</label>
			<div class="login-register-register-form-controls col-sm-8" data-validation="control">
				<input type="text" name="lastname" id="register-lastname" class="login-register-register-form-input form-control">
			</div>
		</div>
		{{#if showCompanyField}}
		<div class="login-register-register-form-controls-group form-group" data-validation="control-group">
			<label class="login-register-register-form-label col-sm-4 control-label" for="register-company">
				{{#if isCompanyFieldRequire}}
					{{translate 'Company <sup class="login-register-register-form-required">*</sup>'}}
				{{else}}
					{{translate 'Company'}} <sup class="login-register-register-form-optional">{{translate '(optional)'}}</sup>
				{{/if}}
			</label>
			<div class="login-register-register-form-controls col-sm-8" data-validation="control">
				<input type="text" name="company" id="register-company" class="login-register-register-form-input form-control"/>
			</div>
		</div>
		{{/if}}
		<div class="login-register-register-form-controls-group form-group" data-validation="control-group">
			<label class="login-register-register-form-label col-sm-4 control-label" for="register-email">
				{{translate 'Email <sup class="login-register-register-form-required">*</sup>'}}
			</label>
			<div class="login-register-register-form-controls col-sm-8" data-validation="control">
				<input type="email" name="email" id="register-email" class="login-register-register-form-input form-control" placeholder="{{translate 'your@email.com'}}">
				<p class="login-register-register-form-help-block help-block">
					<small>
		...
		<div class="login-register-register-form-controls-group form-group" data-validation="control-group">
			<label class="login-register-register-form-label col-sm-4 control-label" for="register-password">
				{{translate 'Password <sup class="login-register-register-form-required">*</sup>'}}
			</label>
			<div class="login-register-register-form-controls col-sm-8" data-validation="control">
				<input type="password" name="password" id="register-password" class="login-register-register-form-input form-control">
			</div>
		</div>

		<div class="login-register-register-form-controls-group form-group" data-validation="control-group">
			<label class="login-register-register-form-label col-sm-4 control-label" for="register-password2">
				{{translate 'Re-Password <sup class="login-register-register-form-required">*</sup>'}}
			</label>
			<div class="login-register-register-form-controls col-sm-8" data-validation="control">
				<input type="password" name="password2" id="register-password2" class="login-register-register-form-input form-control">
			</div>
		</div>
		...
		<div class="login-register-register-form-controls-group form-group">
			<label class="login-register-register-form-label col-sm-offset-4 col-sm-8">
	...
	{{#unless showFormFieldsOnly}}
		<div class="login-register-register-form-controls-group form-group">
			<div class="col-sm-offset-4 col-sm-8">
				<button type="submit" class="login-register-register-form-submit btn btn-warning">
					{{translate 'Register'}}
				</button>
			</div>
		</div>
