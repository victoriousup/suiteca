	...
	,	getContext: function ()
		{
			...
			,	is_confirmation_created = !!(this.model.get('confirmation') && this.model.get('confirmation').internalid !== '0');
			...
			,	showLinkConfirmation: !!(confirmation && confirmation.internalid !== '0')
			...
			,	dwonloadPDFURL: is_confirmation_created ? _.getDownloadPdfUrl({asset:'customer-payment-details', 'id': this.model.get('confirmation').internalid}) : ''
			};
		}
	});
});