...
,	function (_)
{
	...
	_.extend(MerchandisingContext, {
		...
		// @property {Array} handlers list of registered handlers @static
		handlers: []

		// @method registerHandlers pushes a new handler for a specific view to the handler list @static
		// @param {Function} view_constructor @param {Object} methods 
	,	registerHandlers: function (view_constructor, methods)
		...
		// @method removeHandler based on the constructor passed as a parameter
		// it removes any handler that matches the constructor from the handlers list.@static
		// @param {Function} view_constructor @returns the removed handler 
	,	removeHandler: function (view_constructor)
		...
		// @method getHandlerForView @static @returns a handler based on the view
	,	getHandlerForView: function (view)
		...
		// @method escapeValue @static @param {String} value @return {String} 
	...
	,	callHandler: function (callback_key, context, parameters)
		{
		 ...
		 // @method appendFilterValue @static @param {Object} filters @param {String} key @param {to:String,from:String} value
