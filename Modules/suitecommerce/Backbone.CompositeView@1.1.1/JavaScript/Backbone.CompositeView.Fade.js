	...
	)
{
	...
	,	fadeViews: function(fadeFromViewName, fadeToViewName)
		{
			var self = this
			,	fadeFrom = this.childViewInstances[fadeFromViewName]
	...
	,	fadeInView: function(childViewName)
		{
			this.renderChild(childViewName);
			var fadeTo = this.childViewInstances[childViewName];
	...
	,	fadeOutView: function(childViewName)
		{
			var self = this
			,	fadeTo =  this.childViewInstances[childViewName];
