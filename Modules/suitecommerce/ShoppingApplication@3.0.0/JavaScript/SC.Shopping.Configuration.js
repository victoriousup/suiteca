	...
	)
{
	...
	var item_option_templates = {
		'item_views_selected_option_color.tpl': item_views_selected_option_color_tpl
	,	'item_views_selected_option.tpl': item_views_selected_option_tpl

	,	'item_views_option_color.tpl': item_views_option_color_tpl
	,	'item_views_option_dropdown.tpl': item_views_option_dropdown_tpl
	,	'item_views_option_radio.tpl': item_views_option_radio_tpl
	,	'item_views_option_text.tpl': item_views_option_text_tpl
	,	'item_views_option_tile.tpl': item_views_option_tile_tpl
	};

	_.each(BaseConfiguration.itemOptions || [], function (item_option)
	{
	...
	,	seo_image =  function (layout, number)
		{
			...
			,	resized_image = $image.get(my_number) ?
					...
					Utils.getAbsoluteUrl(BaseConfiguration.get.apply(Configuration, ['imageNotAvailable']));
