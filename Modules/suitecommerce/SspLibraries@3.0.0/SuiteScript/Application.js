	...
	,	getEnvironment: function (request)
		{
			...
			,	result = {
				...
				,	useCMS: SC.Configuration.cms.useCMS
				};
	...
	,	getPaginatedSearchResults: function (options)
		{
			...
			var results_per_page = options.results_per_page || SC.Configuration.suitescriptResultsPerPage
			,	page = options.page || 1
	...
	,	getSearchFilterArray: function ()
		{
			...
			,	filter_site = SC.Configuration.filterSite
			,	search_filter_array = [];
...
// TODO: create a server-side exceptions module
// @class badRequestError @extends Application.Error
var badRequestError = {
