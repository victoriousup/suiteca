	...
	)
{
	...
	,	getTypeAheadConfiguration: function ()
		{
			...
			return {
				...
				//@property {Function<String>} displayKey
	...
	,	configureTypeahead: function ()
		...
		//@method getCurrentQuery Get the current search
		//@return {String}
	...
	,	cleanSearch: function (stop_triggering_event)
		...
		//@return {Void}
	,	onItemSelected: function (e, item_id)
		{
	...
	,	setFocus: function ()
		{
			this.$('[data-type="search-input"]').focus();
		}

		// @method loadSuggestionItemsSource Implements the search logic
		// @param {String} query
	...
	,	loadSuggestionItemsSource: function (query, callback)
		...
		//@method selectFirstIfRequire highlight the first item of the suggest
		//@return {Void}
	,	selectFirstIfRequire: function ()
		{
