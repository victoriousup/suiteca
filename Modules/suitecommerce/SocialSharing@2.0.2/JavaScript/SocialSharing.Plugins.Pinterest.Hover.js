	...
	,	shareInPinterestHoverEventListener: function (e)
		{
			...
			if (!image){
				image = jQuery('.item-details-image-gallery-detailed-image').find('img').attr('src');
			}
				...
				,	execute: function (application)
					{
						...
						layout.$el.find('[data-type="social-share-icons-hover"]').append('<a href="#" class="social-sharing-flyout-content-social-pinterest" data-action="share-in-pinterest-hover"><i class="social-sharing-flyout-content-social-pinterest-icon"></i> Pinit</a>');
					}
				});
			}
		}
