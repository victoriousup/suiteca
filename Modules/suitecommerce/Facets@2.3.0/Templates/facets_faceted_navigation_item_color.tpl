			...
			<div class="facets-faceted-navigation-item-color-facet-group-content">
				...
				{{#if showExtraValues}}
					...
					<div class="facets-faceted-navigation-item-color-optionlist-extra-wrapper">
						<button class="facets-faceted-navigation-item-color-optionlist-extra-button" data-toggle="collapse" data-target="#{{htmlId}} .facets-faceted-navigation-item-color-picker-extra" data-action="see-more">
