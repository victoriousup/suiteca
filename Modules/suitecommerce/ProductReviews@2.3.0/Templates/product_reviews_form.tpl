...
<div class="product-reviews-form">
	...
	{{else}}
		...
		<div class="product-reviews-form-divider-desktop"></div>
		...
		<div class="product-reviews-form-content">
			<form id="new-product-review" class="product-reviews-form-new" action="POST">
				<label class="product-reviews-form-content-label-required">
					{{translate 'Required'}}
					<span class="product-reviews-form-content-required">*</span> 
				</label>
				...
				<p class="product-reviews-form-content-title">
					{{translate 'Rating'}} <span class="product-reviews-form-content-required">*</span>
				</p>
				
				<div data-view="Global.StarRating" data-validation="control-group" name="rating" class="product-reviews-form-global-star-rating"></div>
				...
				<div class="product-reviews-form-content-groups">
					<div class="product-reviews-form-content-group" data-validation="control-group" data-input="writerName">
						<label class="product-reviews-form-content-group-label" for="writerName">{{translate 'Your Name'}} <span class="product-reviews-form-content-required">*</span></label>
					...
					<div class="product-reviews-form-content-group" data-validation="control-group" data-input="text">
						<label class="product-reviews-form-content-group-label" for="text">{{translate 'Write your review'}} <span class="product-reviews-form-content-required">*</span></label>
						<div class="product-reviews-form-controls" data-validation="control">
					...
					<div class="product-reviews-form-content-group" data-validation="control-group" data-input="title">
						<label class="product-reviews-form-content-group-label" for="title">{{translate 'A headline for your review'}} <span class="product-reviews-form-content-required">*</span></label>
						<div class="product-reviews-form-controls" data-validation="control">
